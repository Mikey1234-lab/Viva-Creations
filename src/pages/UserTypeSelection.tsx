...
const UserTypeSelection: React.FC = () => {
    ...
    const handleSelection = (type: 'startup' | 'investor') => {
        // Store the selection in localStorage or state management if needed
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-dark-900 to-dark-950 text-white flex items-center justify-center p-4">
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <h3 className="text-xl font-semibold mb-3">I'm a Startup</h3>
                    ...
                    >
                        ...
                        <h3 className="text-xl font-semibold mb-3">I'm an Investor</h3>
                        <p className="text-gray-400 mb-6">
            ...
            {/* Background elements */}
            <motion.div
                className="fixed top-1/4 left-1/6 w-64 h-64 rounded-full bg-primary-500/5 blur-3xl"
                animate={{
                    y: [0, -30, 0],
                    scale: [1, 1.1, 1],
                }}
            ...
            />
            <motion.div
                className="fixed bottom-1/4 right-1/6 w-96 h-96 rounded-full bg-accent-500/5 blur-3xl"
                animate={{
                    y: [0, 30, 0],
                    scale: [1, 1.2, 1],
                }}
