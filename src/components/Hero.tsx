...
const Hero: React.FC = () => {
  ...
  // 3D parallax effect for the title
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      titleRef.current.style.transform = `perspective(1000px) rotateX(${-y}deg) rotateY(${x}deg) scale3d(1, 1, 1)`;
    };
      ...
      >
        ...
        >
              ...
              <div ref={titleRef} className="text-4xl md:text-6xl lg:text-7xl font-bold transition-transform duration-300 ease-out">
                ...
                <div className="hero-title-wrapper">
                  <h1 className="hero-title">
                    <span className="threed-text threed-text-primary">Vivaran  </span>
                    <span className="threed-text threed-text-secondary"> Creations</span>
                  </h1>
                </div>
          ...
          >
            ...
            <motion.button
              className="bg-transparent border border-gray-700 text-gray-300 px-8 py-3 rounded-full transition-all duration-300 w-full sm:w-auto relative overflow-hidden button-3d-outline"
              whileHover={{
                scale: 1.05,
